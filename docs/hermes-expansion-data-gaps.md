...
- **CRM linkage consistency:** ensure every new object can resolve to the CRM IDs (`crm_account_id`, `crm_contact_id`, `crm_opportunity_id`, `crm_policy_id` where applicable).
