"""Tests for hermes.renewals — worksheet rendering and the renewal-worksheet command."""
...
# ------------------------------------------------- renewal-worksheet command

from hermes.commands import renewal_worksheet as rw_mod  # noqa: E402
from hermes.core.dispatcher import Dispatcher, DispatchResult  # noqa: E402
