...
| Job | Cadence | Output |
|---|---|---|
| `--sync-nowcerts` | daily 2:00am | Account Sync v2: NowCerts Insured → CRM Account |
| `--sync-policies` | daily 2:10am | Policy Sync v2: NowCerts Policy → CRM Policy (policies only, no Account writes) |
