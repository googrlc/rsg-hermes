...
description: Dashboard definitions for Lamar's Revenue Command Desk — categories, data sources, filters, columns, sort order, grouping, and metrics for each dashboard type. Use when Lamar asks for a dashboard, pipeline view, or data summary from EspoCRM.
---

# Dashboard Definitions

The dashboard catalog for Lamar's Revenue Command Desk. Each
dashboard is a defined query against EspoCRM with specific columns,
...
**Source:** EspoCRM (Tasks, Opportunities, Renewals)
...
**Source:** EspoCRM Opportunities (stages: Quoting, Markets Out, Proposal Presented)
...
**Source:** EspoCRM Opportunities with missing info flags
...
**Source:** EspoCRM Renewal records + Policy records
...
**Source:** EspoCRM Tasks (status: Waiting on Client) + linked Opportunities
...
**Source:** EspoCRM Tasks/Notes with COI tag
...
**Source:** EspoCRM Opportunities (stage: Closed Lost)
...
**Source:** EspoCRM Accounts + Opportunities (gap analysis)
